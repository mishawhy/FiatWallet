                        ...
                        <div class="content" :style="{ background: '#fff' }">
                            <div v-loading="firstLoading" :class="[{'loading-panel': firstLoading}]">
                                <el-table :show-header="false" style="width: 100%;"
                                          :data="$R.propOr([], 'transactions', data)">
                                    <el-table-column type="expand">
                                        <template slot-scope="props">
                                            <div class="more">
                                                <div class="li-c">
                                                    <small>Reference:</small>
                                                    <p>{{ props.row.ref.length > 0 ? props.row.ref: '-'}}</p>
                                                </div>
                                                <div class="li-c">
                                                    <small>To:</small>
                                                ...
                                                <div class="li-c">
                                                    <small>TxHash:</small>
                                                    <br/>
                                                    <a target="_blank" :href=props.row.hashUrl>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions(['getTransactions', 'getBalance', 'exportCsv']),
